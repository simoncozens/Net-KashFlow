...
my %methods = (
    ...
    ConvertQuoteToInvoice => {
        ...
        parameters => [
            ...
            SOAP::Data->new(
                name => 'deleteQuoteAfterConversion',
                type => 'xsd:int',
                attr => {}
            ),
        ],    # end parameters
...
#push(@parameters, $template->value($result->[2]));
    ...
    $self->uri('KashFlow')->proxy('https://securedwebapp.com/api/service.asmx');
